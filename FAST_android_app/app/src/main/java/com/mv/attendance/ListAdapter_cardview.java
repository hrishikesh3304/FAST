...
public class ListAdapter_cardview extends ArrayAdapter<ListElement_class> {

    public ListAdapter_cardview(Context context, ArrayList<ListElement_class> elementArrayList){
    ...
    if (convertView == null){
        ...
        convertView = LayoutInflater.from(getContext()).inflate(R.layout.listitem_cardview, parent,  false);
    }
